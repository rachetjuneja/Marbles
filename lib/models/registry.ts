...
export const MODELS: ModelDef[] = [
  ...
  },
  {
    ...
    provider: "gemini",
    note: "Gemini 3 Pro Image. Highest fidelity, best for final hero renders.",
    approxCost: "~₹12 to 21",
  ...
  },
  {
    ...
    provider: "flux",
    note: "Black Forest Labs via fal.ai. More control, better self-host and commercial terms.",
    approxCost: "~₹4 to 7",
